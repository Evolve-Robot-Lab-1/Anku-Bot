...
// Home position: CH0=90°, CH1=120°, CH2=180°, CH3=0°, CH4=30°, CH5=90°
// Formula: angle = 90 + ((rad - center) / (range/2)) * 90
const ARM_POSES = {
    home: [0, 0.524, 1.57, -1.57, -2.09, 0],      // Folded/sitting position
    search: [0, 0.524, 1.57, -1.57, -2.09, 0],    // Same as home for now
    prePick: [0, 0.524, 1.57, -1.57, -2.09, 0],   // Same as home for now
    pick: [0, 0.524, 1.57, -1.57, -2.09, 0],      // Same as home for now
    carry: [0, 0.524, 1.57, -1.57, -2.09, 0],     // Same as home for now
    prePlace: [0, 0.524, 1.57, -1.57, -2.09, 0],  // Same as home for now
    place: [0, 0.524, 1.57, -1.57, -2.09, 0]      // Same as home for now
};
...
function sendJointPositions() {
    ...
    const msg = new ROSLIB.Message({
        ...
        name: JOINT_NAMES,
        position: [j1, j2, j3, j4, 0, gripper],
        velocity: [],
        effort: []
    });
    ...
    console.log('Sent joint positions:', [j1, j2, j3, j4, 0, gripper]);
}
