...
Usage:
    # SLAM mode (mapping)
    ros2 launch navigation_bringup navigation.launch.py slam:=true
...
def generate_launch_description():
    pkg_share = FindPackageShare('navigation_bringup')
    lidar_pkg_share = FindPackageShare('ydlidar_ros2_driver')
    ...
    lidar_params_file = PathJoinSubstitution([lidar_pkg_share, 'params', 'X2L.yaml'])
